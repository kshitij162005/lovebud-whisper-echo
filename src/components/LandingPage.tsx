  ...
  const featuredGirlfriends = [
    {
      ...
      name: "Aria Blake",
      age: 24,
      avatar_url: "https://images.unsplash.com/photo-1649972904349-6e44c42644a7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
      ethnicity: "Mixed",
      body_type: "Curvy",
      hair_color: "Blonde",
    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center">
          <div className="mb-16">
            <h1 className="text-6xl md:text-8xl font-bold mb-8 leading-tight">
              <span className="neon-cyan bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent">
                Your Perfect
              </span>
              <br />
              <span className="relative inline-block">
                ...
                <Heart className="absolute -top-6 -right-12 h-10 w-10 text-pink-400 neon-pulse" />
              </span>
            </h1>
            <p className="text-2xl md:text-3xl text-gray-300 mb-12 leading-relaxed max-w-4xl mx-auto">
              Experience <span className="text-pink-400 font-semibold elegant-text">meaningful connections</span> with AI companions who understand you 
              <br />
              <span className="text-cyan-400 font-semibold neon-cyan">and care about your happiness</span>
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-20">
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="sophisticated-border text-cyan-400 hover:bg-cyan-400 hover:text-black text-xl px-12 py-6 font-bold ultra-smooth"
            >
      ...
      <section className="px-6 py-20 relative">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold mb-6 neon-cyan bg-gradient-to-r from-pink-400 to-cyan-400 bg-clip-text text-transparent">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="luxury-card p-8 text-center group relative overflow-hidden crisp-hover">
                <div className="absolute inset-0 bg-gradient-to-br from-pink-500/10 to-cyan-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-200"></div>
                <div className={`inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-pink-500 to-purple-500 mb-6 neon-pulse`}>
                  <item.icon className="h-8 w-8 text-white" />
                </div>
                <div className="text-4xl font-bold text-pink-400 mb-4 elegant-text">{item.step}</div>
      ...
      <section className="px-6 py-20 relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold mb-6 neon-purple bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent">
              Meet Your Potential Companions
            </h2>
            <p className="text-2xl text-gray-300 mb-8">
              Discover <span className="text-pink-400 font-bold elegant-text">unique personalities</span> from around the world, each ready to connect with you
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {featuredGirlfriends.map((girlfriend, index) => (
              <div key={girlfriend.id} className="crisp-hover ultra-smooth">
                <div className="sophisticated-border rounded-2xl p-1">
                  <AIGirlfriendCard 
      ...
      <section className="px-6 py-20 relative">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold mb-6 neon-cyan bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">
              Why Choose LoveBud
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={index} className="luxury-card crisp-hover group overflow-hidden">
                <CardContent className="p-8 text-center relative">
                  <div className="absolute inset-0 bg-gradient-to-br from-pink-500/10 to-cyan-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-200"></div>
                  <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-pink-500 to-purple-500 mb-6 neon-pulse">
        ...
        <div className="max-w-5xl mx-auto text-center">
          <div className="luxury-card p-16 relative overflow-hidden sophisticated-border">
            ...
            <div className="relative z-10">
              <h2 className="text-6xl font-bold mb-8 romantic-glow bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent">
                Ready to Connect?
              </h2>
              <p className="text-2xl text-gray-300 mb-12 leading-relaxed">
                Join <span className="text-pink-400 font-bold elegant-text">thousands</span> who have found their perfect AI companion
                <br />for <span className="text-cyan-400 font-bold neon-cyan">meaningful conversations and emotional connection</span>
              </p>
              <Button 
                size="lg"
                onClick={handleGetStarted}
      ...
      {/* Footer */}
      <footer className="px-6 py-12 border-t-2 border-pink-500/30 relative backdrop-blur-md">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                <Heart className="h-8 w-8 text-pink-400 neon-pulse" />
                <span className="text-2xl font-bold elegant-text bg-gradient-to-r from-pink-400 to-cyan-400 bg-clip-text text-transparent">
                  LoveBud
                </span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-pink-400 ultra-smooth">About Us</a></li>
                <li><a href="#" className="hover:text-pink-400 ultra-smooth">Privacy Policy</a></li>
                <li><a href="#" className="hover:text-pink-400 ultra-smooth">Terms of Service</a></li>
                <li><a href="#" className="hover:text-pink-400 ultra-smooth">Contact</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-xl font-bold text-white mb-4">Support</h3>
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-cyan-400 ultra-smooth">Help Center</a></li>
                <li><a href="#" className="hover:text-cyan-400 ultra-smooth">Community</a></li>
                <li><a href="#" className="hover:text-cyan-400 ultra-smooth">Discord</a></li>
                <li><a href="#" className="hover:text-cyan-400 ultra-smooth">24/7 Support</a></li>
              </ul>
            </div>
            <div>
